...
public class TaxRateSetupSale extends BaseDriver {
    ...
    public void GoodsServiceSetupMethod() throws InterruptedException
    {
        ...
        ///Sale DROPDOWN
        util.selectByIdValue("MainContent_drpTransactionType","3"); //Transaction Type Local Purchase select Dropdown click
        Thread.sleep(1000);
        ///Sale DROPDOWN
