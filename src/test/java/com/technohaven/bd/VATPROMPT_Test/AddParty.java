...
public class AddParty extends BaseDriver {
@Test

	public void AddPartyMethod() throws InterruptedException
	{
        ...
        util.InputCssValue("#MainContent_txtPartyName","ABC LTD2");     //Party Name
